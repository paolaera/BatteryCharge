    ...
    if energy(i) < 0
       ...
       for j = 1:size(battery,1)
        ...
        if VehiclesIn(i) ~= 0
           ...
           bigBattery(i)= bigBattery (i) + energyRemain(i);
...
subplot(2,3,[2,3]);
x=1600:2600;
plot(x,energyDemandPower(1600:2600),x,energySales(1600:2600),x,PVPower(1600:2600));
legend('energyDemand','energySales','PVPower');
...
subplot(2,3,[4,5,6]);
x=1600:2600;
plot(x,Load15min(1600:2600),x,battery(1,1600:2600),x,battery(31,1600:2600),x,battery(61,1600:2600));
